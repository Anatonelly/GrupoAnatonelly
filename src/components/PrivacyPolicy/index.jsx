      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='p-2 rounded fixed bg-white h-[80%] w-1/2 overflow-y-scroll top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]'>
          ...
          <p className='w-full h-auto'>
            A sua privacidade é importante para nós. É política do Grupo
            Anatonelly respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site Grupo Anatonelly, e
          ...
          <p className='w-full h-auto'>
            ...
            informação que o Grupo Anatonelly oferece no site e com caráter
          ...
          <div className='pl-5'>
            ...
            <li>
              ...
              (softwares) do Grupo Anatonelly, de seus fornecedores ou terceiros,
